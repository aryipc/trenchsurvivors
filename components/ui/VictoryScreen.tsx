...
const VictoryScreen: React.FC<VictoryScreenProps> = ({ score, time, onRestart }) => {
    ...
    return (
        <div className="absolute inset-0 bg-gray-900 bg-opacity-90 flex flex-col justify-center items-center z-30 text-white">
            <h1 className="text-8xl text-green-400 mb-4 drop-shadow-[0_2px_2px_rgba(0,255,0,0.5)]">DECENTRALIZATION ACHIEVED</h1>
            ...
            <button
                onClick={onRestart}
                className="bg-green-500 text-gray-900 font-bold py-4 px-10 rounded-lg text-2xl hover:bg-green-400 transition-colors transform hover:scale-105"
            >
                Dig Another Trench
            </button>
        </div>
