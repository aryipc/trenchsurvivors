...
const LevelUpModal: React.FC<LevelUpModalProps> = ({ options, onSelect, descriptions, loading }) => {
    return (
        <div className="absolute inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center z-20">
            <h1 className="text-6xl font-cinzel text-green-400 mb-8 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]">DIG DEEPER!</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {options.map((option) => {
                    ...
                    return (
                        ...
                        >
                            <h2 className="text-2xl font-cinzel text-white mb-2">{option.name}</h2>
