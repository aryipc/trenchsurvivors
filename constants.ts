...
export const DEV_LOCK_ICON = 'data:image/svg+xml;base64,';
...
export const BOSS_SHOCKWAVE_COOLDOWN = 8.0; // seconds
export const BOSS_SHOCKWAVE_DURATION = 1.0; // seconds for the VFX
export const BOSS_SHOCKWAVE_RADIUS = 1000; // The radius of the damage area
export const BOSS_SHOCKWAVE_DAMAGE = 20;
...
// Item constants
export const ITEM_DROP_CHANCE = 0.05; // 5% chance to drop a candle
export const DEV_LOCK_SPAWN_MC = 50000;
export const DEV_LOCK_DROP_CHANCE = 0.01; // 1%
export const MAX_CANDLE_DROPS = 6;
...
export const ITEM_DATA: Record<ItemType, ItemData> = {
    [ItemType.Candle]: {
        ...
        variants: {
            'Gake': {
                name: 'Gake Candle',
                duration: 1.5,      // Two rotations over 1.5 seconds
